...
-- 13. Add foreign key from Project → Unit (after Unit exists)
ALTER TABLE Project
ADD CONSTRAINT FK_Project_Unit FOREIGN KEY (unit_id) REFERENCES Unit(unit_id);
GO
